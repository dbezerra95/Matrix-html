...
function draw() {
    ...
    for (var i = 0; i < drops.length; i++)
    {
        ...
        if (root.rainbow) {
          /* hue += (hueFw) ? 0.01 : -0.01; */
          var rr = Math.floor(0 * Math.sin(root.rainbowSpeed * hue + 0) + 0);
          var rg = Math.floor(127 * Math.sin(root.rainbowSpeed * hue + 2) + 0);
          var rb = Math.floor(0 * Math.sin(root.rainbowSpeed * hue + 4) + 0);
